...
CREATE TABLE CLIENTE (ID  SERIAL NOT NULL, BAIRRO VARCHAR(255), CNPJ VARCHAR(255), CPF VARCHAR(255), LOGRADOURO VARCHAR(255), NOME VARCHAR(255), TELEFONE VARCHAR(255), idEmpresa BIGINT, PRIMARY KEY (ID))
CREATE TABLE EMPRESA (ID  SERIAL NOT NULL, CNPJ VARCHAR(255), CPF VARCHAR(255), NOME VARCHAR(255), PORCENTAGEMCOMISSAOENTREGADOR FLOAT, PRIMARY KEY (ID))
CREATE TABLE FUNCIONARIO (ID  SERIAL NOT NULL, NOME VARCHAR(255), SENHA VARCHAR(255), TELEFONE VARCHAR(255), idEmpresa BIGINT NOT NULL, PRIMARY KEY (ID))
...
CREATE TABLE PEDIDO (ID  SERIAL NOT NULL, DATA DATE, STATUS INTEGER, VALORTOTAL FLOAT, idCliente BIGINT, PRIMARY KEY (ID))
CREATE TABLE PRODUTO (ID  SERIAL NOT NULL, LOCALIZACAO VARCHAR(255), NOME VARCHAR(255), PRIMARY KEY (ID))
